...
export default function AppLayout({ children }) {
    return (
        <div className="min-h-screen bg-background dark">
            ...
            <footer className="border-t border-white/10 bg-black/40 mt-20 backdrop-blur-sm">
                <div className="container mx-auto px-4 py-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                        {/* Brand Section */}
                        <div className="space-y-4">
                            <h3 className="text-2xl font-bold font-display text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">
                                DramaBox
                            </h3>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-sm text-gray-400">
                                ...
                                <li><a href="/browse" className="hover:text-white transition-colors">Browse All</a></li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-sm text-gray-400">
                                ...
                                <li><a href="#" className="hover:text-white transition-colors">Action & Adventure</a></li>
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-white/30 w-full"
                                />
