...
export default function AppLayout({ children }) {
    return (
        <div className="min-h-screen bg-background dark">
            ...
            <footer className="border-t border-white/5 bg-card/50 mt-20 backdrop-blur-xl">
                <div className="container mx-auto px-4 py-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                        {/* Brand Section */}
                        <div className="space-y-4">
                            <h3 className="text-2xl font-bold font-display text-transparent bg-clip-text bg-gradient-to-r from-white to-primary">
                                DramaBox
                            </h3>
                            <p className="text-sm text-muted-foreground leading-relaxed">
                                Your premium destination for Asian entertainment. Stream the latest dramas, movies, and variety shows in high quality.
                            </p>
                        ...
                        {/* Quick Links */}
                        <div>
                            <h4 className="font-semibold text-white mb-6">Discovery</h4>
                            <ul className="space-y-3 text-sm text-muted-foreground">
                                <li><a href="/new-releases" className="hover:text-primary transition-colors">New Releases</a></li>
                                <li><a href="/trending" className="hover:text-primary transition-colors">Trending Now</a></li>
                                <li><a href="/browse" className="hover:text-primary transition-colors">Browse All</a></li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-sm text-muted-foreground">
                                ...
                                <li><a href="#" className="hover:text-primary transition-colors">Action & Adventure</a></li>
                                <li><a href="#" className="hover:text-primary transition-colors">Comedy</a></li>
                                <li><a href="#" className="hover:text-primary transition-colors">Thriller</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="bg-secondary/50 border border-white/10 rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-primary/50 w-full"
                                />
